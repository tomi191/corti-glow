    ...
    <section ref={containerRef} className="bg-[#2D4A3E] py-32 md:py-48 text-[#F7F4F0] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="relative -mx-6 md:mx-0">
          ...
          >
            <CarouselContent className="flex md:grid md:grid-cols-2 lg:gap-12 ml-0">

              {/* Dimension 1: Cortisol */}
              <CarouselItem className="pl-4 md:pl-0 basis-[85%] md:basis-auto flex first:pl-0 md:pr-6 lg:pr-0">
                <motion.div className="w-full flex flex-col gap-6 md:gap-8 bg-[#1E332B] p-8 md:p-14 rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden">
              ...
              <CarouselItem className="pl-4 md:pl-0 basis-[85%] md:basis-auto flex md:pl-6 lg:pl-0">
                <motion.div className="w-full flex flex-col gap-6 md:gap-8 bg-[#EAE7E1] text-[#2D4A3E] p-8 md:p-14 rounded-[2.5rem] mt-0 md:mt-24 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex justify-center gap-4 mt-6 md:hidden px-6">
              <CarouselPrevious className="static translate-y-0 translate-x-0 w-12 h-12 bg-white/10 text-[#F7F4F0] border border-white/20 shadow-lg hover:bg-white/20" />
              <CarouselNext className="static translate-y-0 translate-x-0 w-12 h-12 bg-[#B2D8C6] text-[#2D4A3E] border-none shadow-lg hover:bg-[#9AC8B6]" />
            </div>
          </Carousel>
        </div>
      </div>
