  ...
  return (
    <section className="bg-[#EAE7E1] py-32 md:py-48 text-[#2D4A3E]">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-16 md:gap-24">
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-[420px] gap-6 md:gap-8">

          {/* Item 1: Tall Vertical Image + Quote Overlay */}
          <div className="group relative col-span-1 md:col-span-4 rounded-[2.5rem] bg-[#2D4A3E] overflow-hidden aspect-auto row-span-2 shadow-sm">
            <img
              src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80"
              alt="Woman relaxed"
              className="w-full h-full object-cover opacity-80 mix-blend-screen grayscale group-hover:scale-105 transition-transform duration-700"
            />
          ...
          <div className="group col-span-1 md:col-span-4 rounded-[2.5rem] bg-white p-8 flex flex-col justify-center border border-[#2D4A3E]/5 shadow-sm hover:shadow-xl transition-shadow duration-500">
          ...
          <div className="group relative col-span-1 md:col-span-4 rounded-[2.5rem] bg-[#DCD8D0] overflow-hidden shadow-sm">
            <img
              src="https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&q=80"
              alt="Morning routine"
              className="w-full h-full object-cover mix-blend-multiply opacity-60 grayscale group-hover:scale-105 transition-transform duration-700"
            />
          ...
          <div className="group col-span-1 md:col-span-8 rounded-[2.5rem] bg-[#2D4A3E] p-10 md:p-14 flex flex-col justify-center text-[#F7F4F0] relative overflow-hidden shadow-sm">
