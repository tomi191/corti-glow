...
const features = [
  ...
  },
  {
    icon: Brain,
    color: "#FFC1CC",
    title: "Спокойствие отвътре",
    description:
      "Ашваганда (5% витанолиди) намалява кортизола с до 27% за спокоен ум и тяло.",
    stat: "-27%",
    statLabel: "кортизол",
  },
  {
    ...
    <section ref={ref} className="py-16 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            Защото витамините на сутринта не спират стреса на вечерта.
          </motion.p>
        </div>
