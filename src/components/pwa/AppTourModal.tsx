...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: "Дневен запис",
    description:
      "Натисни кръга на началния екран — записваш сън, стрес и симптоми за 10 секунди. Виждаш резултат за деня.",
  },
  {
    icon: CalendarDays,
    ...
    description:
      "Виж фазите на цикъла си. Натисни минал ден, за да видиш записа. Днешният ден отваря нов.",
  },
  {
    icon: BarChart3,
    ...
    description:
      "След 3+ записа виждаш тенденции в съня и стреса, свързани с фазите ти. Без гадаене.",
  },
  {
    icon: ShoppingBag,
